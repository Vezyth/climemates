    ...
    <div id="carouselExampleInterval" class="carousel slide carousel-fade " data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="5000" style="">
                <img src="https://thumbs.dreamstime.com/b/idyllic-green-fields-vibrant-blue-sky-panoramic-landscape-vast-hills-fluffy-white-clouds-76383482.jpg" class="d-block w-100" alt="..." style="height: 700px; object-fit: cover;">
                <div class="mask" style="background-color: hsla(0, 0%, 0%, 0.6)"></div>
                <div class="carousel-caption d-none d-md-block ">

                    <img src="https://cdn.discordapp.com/attachments/852892372072923147/1099262320846327838/banner.png" >
                    <h1 class="text-white">Biochar production with ClimeMates </h1>
                    <p class="banner_text text-justify">Biochar is a carbon-rich soil supplement created through pyrolysis, which locks up carbon in the ground. Our specialists provide advice on manufacturing biochar, choosing feedstock, pyrolysis system layout, and application strategies to improve agricultural yields, reduce emissions, and enhance soil health.
                        At ClimeMates, we're committed to promoting sustainable practices that benefit both the environment and society. Unfortunately this service is still underdevelopment. Please follow our social media for later update. </p>
                    <br>
                    <p class="banner_text"> Please follow our social media for later update.</p>
            ...
            <div class="carousel-item" data-bs-interval="5000" style="">
                <img src="https://img.freepik.com/free-photo/top-view-salad-with-onions-copy-space_23-2148622469.jpg?w=826&t=st=1681463159~exp=1681463759~hmac=f39b0a11bb49beb48c2527fbe99998e594c8e4b95af693e462247aacd14f6cc6" class="d-block w-100"  style="height: 700px; object-fit: cover;" alt="...">
                <div class="mask" style="background-color: hsla(0, 0%, 0%, 0.6)"></div>
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item" data-bs-interval="5000" style="">
                <img src="https://cdn.discordapp.com/attachments/852892372072923147/1096500812810833980/image.png" class="d-block w-100"  style="height: 700px; object-fit: cover;" alt="...">
                <div class="mask" style="background-color: hsla(0, 0%, 0%, 0.6)"></div>
                <div class="carousel-caption d-none d-md-block">
                    <h1 class="invisible">.</h1>
                    <img src="https://cdn.discordapp.com/attachments/852892372072923147/1099262320846327838/banner.png">
